...
from mailboxzero import services
from mailboxzero import utils

from mailboxzero.config import DEFAULTS
...
def main():
    ...
    options = {
        "debug": args.debug,
        "domains": {domain: {"max_email_age": max_email_age} for domain in domain_list},
